...
type PaymentClient interface {
	Execute(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*CreatePaymentResponse, error)
}
...
func (c *paymentClient) Execute(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*CreatePaymentResponse, error) {
	out := new(CreatePaymentResponse)
	err := c.cc.Invoke(ctx, Payment_Execute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServer interface {
	Execute(context.Context, *CreatePaymentRequest) (*CreatePaymentResponse, error)
...
func (UnimplementedPaymentServer) Execute(context.Context, *CreatePaymentRequest) (*CreatePaymentResponse, error) {
...
func _Payment_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).Execute(ctx, req.(*CreatePaymentRequest))
	}
